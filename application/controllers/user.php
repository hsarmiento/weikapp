...
class User extends CI_Controller 
{
	...
	public function login()
	{
		...
		else
		{
			...
			{
				$aData['login_url'] = $this->facebook_utils->get_login_url(array('scope' => 'email,user_birthday,sex,link,publish_stream,publish_actions','redirect_uri' => base_url().'user/login'));				
